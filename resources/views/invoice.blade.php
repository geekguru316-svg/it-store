        ...
        <table style="width: 100%; margin-bottom: 30px;">
            <tr>
                ...
                <td class="invoice-title">
                    Invoice<br>
                    <span style="font-size: 14px; color: #1d4ed8; font-weight: normal; font-family: monospace;">#{{ $order->id }}</span>
                </td>
            </tr>
        </table>
        ...
        <table class="info-grid">
            <tr>
                <td>
                    ...
                    <div class="subval">{{ $order->customer_email }}</div>
                </td>
                <td style="text-align: right;">
                    <div class="label">Date Issued:</div>
                    <div class="val" style="font-size: 14px;">{{ $order->created_at->format('M d, Y') }}</div>
                    <div class="label" style="margin-top: 10px;">Status:</div>
                    <div class="val" style="color: #1d4ed8; font-style: italic; text-transform: uppercase; font-size: 14px;">{{ $order->status }}</div>
                </td>
            </tr>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <div style="font-size: 10px; color: #9ca3af; font-weight: normal;">SKU-{{ substr(md5($item['name']), 0, 8) }}</div>
                    </td>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="text-align: right;">
                    ...
                    <span style="font-weight: 700; color: #111; margin-left: 10px;">₱{{ number_format($order->total, 2) }}</span>
                    <br>
