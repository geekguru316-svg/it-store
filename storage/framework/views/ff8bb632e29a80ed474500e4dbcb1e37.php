<?php $__env->startSection('title', 'Welcome to IT Store'); ?>
    ...
    <div class="site-content">
                    ...
                    <div
                        ...
                        <div class="relative z-10">
                            ...
                            <div class="flex justify-between items-baseline">
                                <p class="text-red-600 text-xl font-black italic">₱<?php echo e(number_format($product->price * 0.8, 2)); ?>
                            ...
                            <div class="flex gap-2 relative z-20">
                                ...
                                <a href="<?php echo e(route('checkout.index', ['id' => $product->id, 'quantity' => 1])); ?>"
                    ...
                    <div
                        ...
                        <div class="p-6 relative z-10 flex flex-col h-full">
                            ...
                            <p class="text-[10px] text-gray-500 mb-4 line-clamp-2 leading-relaxed h-8">
                                <?php echo e(Str::limit($product->description, 60)); ?></p>
        ...
        <?php else: ?>
            <div class="text-center py-20 text-gray-500 bg-white rounded-3xl border-2 border-dashed border-gray-200">
                ...
                <a href="<?php echo e(route('home')); ?>" class="text-blue-600 underline mt-2 inline-block">Back to all products</a>
            </div>
        <?php endif; ?>
    ...
    <div class="bg-blue-50 py-16 text-center border-t border-b border-blue-100 mt-8">
        <div class="max-w-3xl mx-auto px-4">
            ...
            <p class="mt-4 text-blue-800 text-lg leading-relaxed font-medium">
                Managed and developed by <strong class="bg-blue-600 text-white px-2 py-1 rounded-md mx-1 shadow-sm">Arjun
                    Haincadto</strong>.<br>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Glenda Agnes\product-site\resources\views/welcome.blade.php ENDPATH**/ ?>