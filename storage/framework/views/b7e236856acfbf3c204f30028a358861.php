...
<?php $__env->startSection('title', 'Admin Dashboard - IT Store'); ?>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="category" name="category"
                                ...
                                <?php $__currentLoopData = \App\Models\Product::categories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900"><?php echo e($product->name); ?></h3>
                                        <p class="text-blue-600 font-medium">₱<?php echo e(number_format($product->price, 2)); ?></p>
                                        <p class="text-xs text-gray-500">Stock: <?php echo e($product->stock); ?> | Sold: <?php echo e($product->sold_count); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Glenda Agnes\product-site\resources\views/admin.blade.php ENDPATH**/ ?>