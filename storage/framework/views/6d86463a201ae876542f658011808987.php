...
<div class="p-6">
    ...
    <div class="max-w-2xl mx-auto">
                    ...
                    <div class="flex items-center">
                        <div class="h-12 w-12 bg-white rounded border flex items-center justify-center mr-3">
                             <?php if($product->image): ?>
                                <img src="<?php echo e(asset('storage/' . $product->image)); ?>" class="h-10 w-10 object-contain">
                             <?php else: ?>
                                <span class="text-xs text-gray-400 font-bold">IT</span>
                             <?php endif; ?>
                        </div>
                        <div>
                            <p class="font-bold text-gray-800 text-sm"><?php echo e($product->name); ?></p>
                            <p class="text-xs text-gray-500">Qty: <?php echo e($quantities[$product->id] ?? 1); ?></p>
                        </div>
                    </div>
                    <span class="font-bold text-gray-900">₱<?php echo e(number_format($product->price * ($quantities[$product->id] ?? 1), 2)); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
                <div class="flex justify-between text-xl font-black border-t border-gray-200 pt-4 mt-2">
                    <span class="text-gray-700">Total Amount</span>
                    <span class="text-indigo-600">₱<?php echo e(number_format($total, 2)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="mt-8 text-center">
            <a href="<?php echo e(route('cart.index')); ?>" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-medium transition-colors group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Glenda Agnes\product-site\resources\views/checkout.blade.php ENDPATH**/ ?>